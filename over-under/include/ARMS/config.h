...
// Ticks per inch
#define TPI 29.38 			  // Encoder ticks per inch of forward robot movement
#define MIDDLE_TPI 0          // Ticks per inch for the middle wheel

// Tracking wheel distances
#define TRACK_WIDTH 11 		  // The distance between left and right wheels (or tracker wheels)
#define MIDDLE_DISTANCE 0     // Distance from middle wheel to the robot turning center

// Sensors
#define IMU_PORT 90                        // Port 0 for disabled
...
#define ANGULAR_KP 3.7
#define ANGULAR_KI 0
#define ANGULAR_KD 26
#define MIN_ERROR 15        // Minimum distance to target before angular componenet is disabled
#define LEAD_PCT .6			 // Go-to-pose lead distance ratio (0-1)

// Auton selector configuration constants
#define AUTONS "Close", "Far","Solo","74100X","Nothing" // Names of autonomi, up to 10
#define HUE 30     // Color of theme from 0-359(H part of HSV)
